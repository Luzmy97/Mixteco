export const CONFIG = {
  ...
  language: 'Mixteco', // This changes the display name for your language
  wordLength: 5, // This sets how long each word is based on how many characters (as defined in orthography.ts) are in each word
  author: 'Mary', // Put your name here so people know who made this Wordle!
  ...
  defaultLang: 'mxt', // the default interface language
  availableLangs: ['ay', 'es','en', 'sw', 'zh','mxt'], // the options available to the user for translation languages
